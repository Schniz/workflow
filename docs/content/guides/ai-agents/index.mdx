...
<Cards>
  <Card title="Streaming Updates from Tools" href="/guides/ai-agents/streaming-updates-from-tools">
  ...
  <Card title="Sleep, Suspense, and Scheduling" href="/guides/ai-agents/sleep-and-delays">
